...
def test_compute_grouped_pearson_tracking_averages_by_investor():
    events = [
        {
            "user_id": "u1",
            "theta_true": {"risk_sensitivity": 0.2, "patience_level": 0.3, "analytical_thinking": 0.4, "controlled_perception": 0.5},
            "theta_inferred": {"risk_sensitivity": 0.1, "patience_level": 0.2, "analytical_thinking": 0.3, "controlled_perception": 0.4},
        },
        {
            "user_id": "u1",
            "theta_true": {"risk_sensitivity": 0.4, "patience_level": 0.5, "analytical_thinking": 0.6, "controlled_perception": 0.7},
            "theta_inferred": {"risk_sensitivity": 0.3, "patience_level": 0.4, "analytical_thinking": 0.5, "controlled_perception": 0.6},
        },
        {
            "user_id": "u2",
            "theta_true": {"risk_sensitivity": 0.8, "patience_level": 0.7, "analytical_thinking": 0.6, "controlled_perception": 0.5},
            "theta_inferred": {"risk_sensitivity": 0.7, "patience_level": 0.6, "analytical_thinking": 0.5, "controlled_perception": 0.4},
        },
        {
            "user_id": "u2",
            "theta_true": {"risk_sensitivity": 0.6, "patience_level": 0.5, "analytical_thinking": 0.4, "controlled_perception": 0.3},
            "theta_inferred": {"risk_sensitivity": 0.5, "patience_level": 0.4, "analytical_thinking": 0.3, "controlled_perception": 0.2},
        },
    ]

    result = compute_grouped_pearson_tracking(events, group_key="user_id")

    assert result["num_groups"] == 2
    assert result["group_correlations"]["u1"]["risk_sensitivity"] == pytest.approx(1.0)
    assert result["group_correlations"]["u2"]["risk_sensitivity"] == pytest.approx(1.0)
    assert result["dimension_correlation"]["risk_sensitivity"] == pytest.approx(1.0)
    assert result["overall_average_correlation"] == pytest.approx(1.0)


def test_compute_static_baseline_metrics_uses_row_level_static_theta_when_available():
    events = [
        {
            "theta_true": {"risk_sensitivity": 0.2, "patience_level": 0.2, "analytical_thinking": 0.2, "controlled_perception": 0.2},
            "theta_inferred": {"risk_sensitivity": 0.2, "patience_level": 0.2, "analytical_thinking": 0.2, "controlled_perception": 0.2},
            "theta_static": {"risk_sensitivity": 0.1, "patience_level": 0.1, "analytical_thinking": 0.1, "controlled_perception": 0.1},
        },
        {
            "theta_true": {"risk_sensitivity": 0.8, "patience_level": 0.8, "analytical_thinking": 0.8, "controlled_perception": 0.8},
            "theta_inferred": {"risk_sensitivity": 0.75, "patience_level": 0.75, "analytical_thinking": 0.75, "controlled_perception": 0.75},
            "theta_static": {"risk_sensitivity": 0.9, "patience_level": 0.9, "analytical_thinking": 0.9, "controlled_perception": 0.9},
        },
    ]

    result = compute_static_baseline_metrics(events)

    assert result["static_overall_rmse"] == pytest.approx(0.1)
    assert result["dynamic_overall_rmse"] == pytest.approx((0.005 / 4) ** 0.5)
